...
class STTRequest(BaseModel):
    ...
    language: Optional[str] = "ko"           # 언어 힌트 (None이면 자동)
    do_vad: bool = False                     # 무음 제거 사용 여부
    low_conf_retranscribe: bool = True       # 저신뢰 구간 재추론
    low_conf_threshold: float = -1.0         # avg_logprob 임계값
